...
#RMSE and Text
dat_text <- data.frame(
label = c("RMSE: 0.72", "RMSE: 0.07", "RMSE:0.47", "RMSE: 0.31", "RMSE: 0.12", "RMSE: 0.19"),
...
label = c("h: 2.97", "h: 0.19", "h: 1.39", "h: 1.72", "h: 2.11", "h = 2.11"  ),
 variable   = c("Ambient Temperature","Cooler with Ice","Tray with Ice","Tray with Ice Packs","Refrigerated Tray","Refrigeration"),
  x     = c(30, 30, 30,30,30, 20),
...
ggsave("Training Set.jpg", width =8, height = 5, units = "in", dpi = 300)
...
#RMSE and Text
dat_text <- data.frame(
label = c("RMSE: 0.43", "RMSE: 0.06", "RMSE:1.12", "RMSE: 0.64", "RMSE: 0.41", "RMSE: 1.25"),
 variable   = c("Ambient Temperature","Cooler with Ice","Tray with Ice","Tray with Ice Packs","Refrigerated Tray","Refrigeration"),
...
ggsave("Testing Set.jpg", width =8, height = 5, units = "in", dpi = 300)
