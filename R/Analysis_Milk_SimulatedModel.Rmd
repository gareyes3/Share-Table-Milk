...
Outputs_RTB<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_RTB, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_RT<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_RT, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_TIP<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_TIP, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_TIC<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_TIC, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_CI<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_CI, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_RTB_refB<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_RTB_refB, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)

Outputs_RTB_18C<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_RTB_18C, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_RTB_21C<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_RTB_21C, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
Outputs_RTB_23C<-Obtaining_Spoiled_Milks(Temp_Profile = Df_RT_MT_RTB_23C, N_Years = 20 ,Service_Length = 50 ,TurningT_Length = 25)
...
Extracting_Total_SpoiledMilks<-function(Output_Name, N_Years){
  Total_Milks<-c()
  for( i in 1:N_Years){
    Total_Milks[i]<-Outputs_RTB[[2]][[i]][[3,2]]
  }
  return(Total_Milks)
}

##Baseline RTB
Extracting_Total_Milks(Output_Name = Outputs_RTB, N_Years = 20)
Extracting_Total_SpoiledMilks(Output_Name = Outputs_RTB, N_Years = 20)

##Baseline RTB
Extracting_Total_Milks(Output_Name = Outputs_RTB_refB, N_Years = 20)
Extracting_Total_SpoiledMilks(Output_Name = Outputs_RT_refB, N_Years = 20)
