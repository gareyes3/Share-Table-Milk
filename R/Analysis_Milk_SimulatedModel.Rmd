...
- To Change the Service Time: XXXX
- To change the In between Service Time: XXXX
- To Change the Overnight Storage time: XXX
...
## Importing generated Time and Temp Data
...
## Generating an Initial DF for each of the conditions
```{r}
AnalysysDF_RTB<- AnalysysDF
AnalysysDF_RT<- AnalysysDF
AnalysysDF_TIP<- AnalysysDF
AnalysysDF_TIC<- AnalysysDF
AnalysysDF_CI<- AnalysysDF
```
