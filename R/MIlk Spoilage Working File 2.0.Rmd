...
```{r}
All_Combined_Plots<-rbind(Milkdf_RTB_FT_Melted,Milkdf_Melted_TI_FT, Milkdf_Melted_TI_HT,Milkdf_RefT_FT_Melted,Milkdf_RefT_HT_Melted,
...
All_Combined_Plots$type<-factor(All_Combined_Plots$type, levels = c("Initial","Room Temp B","Tray with Ice Full Time","Tray with Ice Half Time","Refrigerated Tray Full Time" ,"Refrigerated Tray Half Time","Tray with Ice Packs Full Time","Tray with Ice Packs Half Time","Cooler with Ice Full Time","Cooler with Ice Half Time"))
...
All_Combined_Plots %>%
  ...
  labs(y = "log CFU/mL")+
  geom_hline(yintercept = 4.30, color = "red", size = 1)+
  geom_hline(yintercept = 1.99, color = "blue", size = 1, alpha = 0.7, linetype='dashed')+
...
```{r}
All_Temperatures_Combined<-rbind(RTB_L_NT,TI_L_FT,RefT_L_FT,TIP_L_FT,CI_L_FT, TI_L_HT, RefT_L_HT,TIP_L_HT,CI_L_HT)

All_Temperatures_Combined$condition<-factor(All_Temperatures_Combined$condition, levels =c( "Room Temp B", "Tray with Ice", "Refrigerated Tray", "Tray with Ice Packs", "Cooler with Ice"))

All_Temperatures_Combined %>% 
  ggplot(aes(x = min, y = means, color = treatment))+
  geom_smooth()+
