...
aaaa<-as.data.frame(apply(Milkdf,1,Spoilage_Function_Apply, Time_Temp_df = RTB_L_NT_B1))
t(aaaa)
```
...
for (i in 1:N_Days){
 #Service 1:
Milkdf<-Spoilage_Function(Milkdf,TI_L_NT_L1)
#Break 1:
Milkdf<-Spoilage_Function(Milkdf,TI_L_NT_B1)
#Lunch 2:
Milkdf<-Spoilage_Function(Milkdf,TI_L_NT_B1) 
}
