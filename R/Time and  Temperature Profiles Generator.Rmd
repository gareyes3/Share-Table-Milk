...
#RMSE and Text
dat_text <- data.frame(
label = c(paste("Peak Temp",Max_RTB,"°C"), 
          paste("Peak Temp",Max_RT,"°C"), 
          paste("Peak Temp",Max_TIC,"°C"), 
          paste("Peak Temp",Max_TIP,"°C"), 
          paste("Peak Temp",Max_CI,"°C"),
          paste("Peak Temp",Max_RTB_refB,"°C")),
Condition   = c("Ambient Temperature 72°F (22.1°C)", "Refrigerated Tray", "Tray with Ice Packs", "Tray with Ice", "Cooler with Ice", "Ambient with Intermediate Refrigeration"),
  x     = c(6700, 6700, 6700,6700,6700,6700),
  y     = c(15, 15, 15,15,15,15)
)
