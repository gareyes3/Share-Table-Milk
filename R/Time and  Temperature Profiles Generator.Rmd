...
Df_RT_MT_RTB_18C_melted$Condition = "Room Temp B 18.3°C"
...
Df_RT_MT_RTB_21C_melted$Condition = "Room Temp B 21.1°C"
...
Df_RT_MT_RTB_23C_melted$Condition = "Room Temp B 23.8°C"
...
Temp_Milk_Vectors_Ref_2C<-predict_full_milk_temp(df = Time_Temp_Df_Ref_2C, Temp_Initial = 4.2)
...
Df_RT_MT_Ref_2C_melted$Condition = "Refrigeration Temp 2C"
...
Df_RT_MT_Ref_7C_melted$Condition = "Refrigeration Temp 7C"
...
All_6_melted$Condition<-factor(All_6_melted$Condition, levels = c("Baseline", "Refrigerated Tray", "Tray with Ice Packs", "Tray with Ice", "Cooler with Ice", "Baseline Ref Break"))
...
ggsave("Pedicted Time and Temp Profiles/All Temp Combined.png", height = 5, width = 9, dpi = 300)


```

```{r}
All_Temp_melted<-rbind(Df_RT_MT_RTB_melted,
                       Df_RT_MT_RTB_18C_melted,
                       Df_RT_MT_RTB_21C_melted,
                       Df_RT_MT_RTB_23C_melted)

All_Temp_melted$Condition<-str_replace(All_Temp_melted$Condition, pattern = "Room Temp B", replacement = "Baseline")

All_Temp_melted$Condition<-factor(All_Temp_melted$Condition, levels = c("Baseline", "Baseline 18.3°C","Baseline 21.1°C","Baseline 23.8°C"))
